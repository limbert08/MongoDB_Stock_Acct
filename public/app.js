...
function displayResults(transactions) {
  ...
  transactions.forEach(function(transaction) {
    ...
    $("tbody").append("<tr><td>" + transaction.tran_id + "</td>" +
                         "<td>" + transaction.acct_id + "</td>" +
                         "<td>" + transaction.tran_symbol + "</td>" +
                         "<td>" + transaction.tran_desc + "</td>" +
                         "<td>" + transaction.symbol_market_value + "</td></tr>");
  });
}
